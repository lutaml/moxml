...
|* [x]
|* [x]
|* [x]footnote:[May have issues, especially when manipulating Text nodes]

|Basic XPath
|* [x]
|* [x]
|* [x]
|locatefootnote:locate[OThe native Ox method `locate` is similar to XPath but has a different syntax.]
