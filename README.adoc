...
# In your Gemfile
gem 'moxml'
gem 'nokogiri'  # Or 'oga', or 'ox' when it is integrated, or 'rexml'
----
...
`:rexml`:: https://github.com/ruby/rexml[REXML], a pure Ruby XML parser included in the Ruby standard library
