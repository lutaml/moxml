...
NOTE: Ox's node manipulation may have issues, especially when manipulating Text nodes.

NOTE: The native Ox method `locate` is similar to XPath but has a different syntax.
