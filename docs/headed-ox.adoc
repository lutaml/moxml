...
image:https://img.shields.io/badge/Pass_Rate-99.20%25-brightgreen[HeadedOx v1.2 Pass Rate]
...
**Version 1.2 Status:** 99.20% test pass rate (1,992/2,008 tests) - PRODUCTION READY
...
* link:RELEASE_NOTES_V1.2.adoc[] - Version 1.2 release notes (508 lines)
