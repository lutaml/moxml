...
module Moxml
  module Adapter
    module CustomizedLibxml
      ...
      autoload :EntityReference, "moxml/adapter/customized_libxml/entity_reference"
      autoload :Node, "moxml/adapter/customized_libxml/node"
      autoload :ProcessingInstruction, "moxml/adapter/customized_libxml/processing_instruction"
